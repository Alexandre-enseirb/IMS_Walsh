...
nBuffers = 2;
nSamplesBuffered = nBuffers*radioParams.RxOversampling*commParams.nFramesTx*datalength;
...
while true
    ...
    [buffer1((i-1)*datalength+1:i*datalength), ~, overrun] = radio();
    ...
    buffer2((ii-1)*datalength+1:ii*datalength) = buffer1((i-1)*datalength+1:i*datalength);
