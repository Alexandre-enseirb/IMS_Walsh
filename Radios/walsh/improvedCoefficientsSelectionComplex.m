function [combinations] = improvedCoefficientsSelectionComplex(nCoefficientsToSelect, ...
    cluster, ...
    carrier, ...
    ...
    stopAtMax, ...
    params)
%IMPROVEDCOEFFICIENTSSELECTIONCOMPLEX generates combination of modulated Walsh coefficients
%
