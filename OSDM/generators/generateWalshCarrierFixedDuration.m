function [carriers, stats] = generateWalshCarrierFixedDuration(params, nIter, filename, duration, coeffsAmnt)
...
carriers{1}.available = ordered_coeffs(coeffsAmnt+1:end);
carriers{1}.carrierCoeffs = ordered_coeffs(1:coeffsAmnt);
