function [sig] = generateSigFromCombination(combination, carrier, attenuation, params)
...
nCoeffs = size(combination, 2);

modulatedCoeffs = combination(1,:);
Sk = combination(2:end, :).';
