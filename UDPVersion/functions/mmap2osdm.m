function [sig] = mmap2osdm(commParams, walshParams, mmap, mappingType, datatype)
%MMAP2OSDM convertit une image mappee en memoire en signal OSDM pour etre transmis par une radio USRP-B210.
%Fichier temporaire le temps de trouver et de corriger tous les scripts utilisant l'ancienne version
%
%   [sig] = mmap2osdm(commParams, walshParams, mmap)
%
%   [sig] = mmap2osdm(commParams, walshParams, mmap, mappingType)
%
%   [sig] = mmap2osdm(commParams, walshParams, mmap, mappingType, datatype)
