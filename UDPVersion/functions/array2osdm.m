function [sig] = array2osdm(commParams, walshParams, data, mappingType, datatype)
    %ARRAY2OSDM convertit une image mappee en memoire en signal OSDM pour etre transmis par une radio USRP-B210.
    %Fichier temporaire le temps de trouver et de corriger tous les scripts utilisant l'ancienne version
    %
    %   [sig] = array2osdm(commParams, walshParams, data)
    %
    %   [sig] = array2osdm(commParams, walshParams, data, mappingType)
    %
    %   [sig] = array2osdm(commParams, walshParams, data, mappingType, datatype)
    ...
    % Lecture de la source d'information (deja au bon format)
    I = data;
