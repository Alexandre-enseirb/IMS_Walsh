function [params] = getCommParamsForWalshOverUDP(type)
...
% Adresse IPv4 de l'ordinateur servant d'emetteur
params.UDP.TxInetAddr = "169.254.103.193";
% Adresse IPv4 de l'ordinateur servant de recepteur
params.UDP.RxInetAddr = "169.254.158.40";
% Port de communication udp
params.UDP.Port = 8080;
